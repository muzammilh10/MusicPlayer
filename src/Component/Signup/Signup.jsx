    ...
    <div className='bg-white text-black text-center mx-auto '>
        ...
        <form onSubmit={registerUser} className='text-center mx-auto '>
            ...
            <div className='w-full text-left pt-2 flex justify-center'>
                <input type="submit" id='submit' name='submit' className='block w-3/4 outline-none p-2 hover:scale-105 transition-all duration-200 bg-green-500 hover:bg-green-400 text-black hover:font-semibold text-center rounded-full' value="Sign up" />
            </div>

        </form>
        <p className='pt-2'><span className='text-black font-semibold'>Already have an account?</span> <Link to="/login" className='text-black font-semibold underline text-center hover:text-green-500'>Log in for Spotify</Link></p>
    </div>
</div>
